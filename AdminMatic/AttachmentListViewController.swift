 ...
 */
        ...
        layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/get/fieldNotes.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
