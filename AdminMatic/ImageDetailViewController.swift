...
class ImageDetailViewController: UIViewController, UIDocumentInteractionControllerDelegate, UIScrollViewDelegate, NoInternetDelegate{
    ...
    @objc func handleLike(){
        ...
        parameters = ["companyUnique": self.appDelegate.defaults.string(forKey: loggedInKeys.companyUnique)!,"sessionKey": self.appDelegate.defaults.string(forKey: loggedInKeys.sessionKey)!, "empID":self.appDelegate.loggedInEmployee?.ID, "imageID":self.image.ID] as! [String : String]
        ...
        if(self.image.liked == "0"){
            ...
            layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/new/like.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
            ...
            layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/delete/like.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
                .validate()    // or, if you just want to check status codes, validate(statusCode: 200..<300)
                .responseString { response in
                    print("images response = \(response)")
                }
