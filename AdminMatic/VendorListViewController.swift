...
class VendorListViewController: ViewControllerWithMenu, UITableViewDelegate, UITableViewDataSource, UISearchControllerDelegate, UISearchBarDelegate, UISearchDisplayDelegate, UISearchResultsUpdating, NoInternetDelegate{
    ...
    func getVendorList() {
        ...
        self.layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/get/vendors.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
