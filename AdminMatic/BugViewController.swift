...
class BugViewController: UIViewController, UITextViewDelegate{
    ...
    @objc func saveData(){
        ...
        if(self.descriptionTxtView.text != descriptionPlaceHolder){
            ...
            layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/new/bug.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
