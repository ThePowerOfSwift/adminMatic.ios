...
class UsageEntryViewController: UIViewController, UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource,  UITableViewDelegate, UITableViewDataSource, UsageDelegate, AttachmentDelegate,  UpdateReceiptImageDelegate, NoInternetDelegate{
    ...
    internal func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
        ...
        if(indexPath.row == usageToLog.count && woItem.type != "1"){
            ...
            if(usage.type == "1"){
                ...
                if usage.empPic != nil{
                    cell.setImageUrl(_url: "https://adminmatic.com/uploads/general/thumbs/"+usage.empPic!)
                }
    ...
    func callAlamoFire(_type:String){
        ...
        if(usageToLog.count > 0){
            ...
            layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/update/usage.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
