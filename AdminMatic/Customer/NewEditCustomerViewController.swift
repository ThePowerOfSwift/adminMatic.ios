...
class NewEditCustomerViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate, UITextViewDelegate,  UIScrollViewDelegate, NoInternetDelegate {
   ...
   //company switch
    ...
    func getCustomerInfo(){
        ...
        var parameters:[String:AnyObject]
                      parameters = [
                          "ID":self.customerID as AnyObject, "sessionKey": self.appDelegate.defaults.string(forKey: loggedInKeys.sessionKey)! as AnyObject, "companyUnique": self.appDelegate.defaults.string(forKey: loggedInKeys.companyUnique)! as AnyObject
                      ]
                      ...
                      self.layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/get/customer.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
                          ...
                          .responseJSON(){
                              response in
                                        ...
                                        do{
                                            ...
                                            //self.customerArray = customers.customers
                                            
                                            self.customer = customers.customers[0]
                                            self.parseCustomer()
 ...
 */
    ...
    func parseCustomer(){
        ...
        if self.customer.companyName != nil{
            self.companyValue = self.customer.companyName!
        }
        if self.customer.salutation != nil{
            self.salutationValue = self.customer.salutation!
        }
        if self.customer.fname != nil{
            self.fNameValue = self.customer.fname!
        }
        if self.customer.mname != nil{
            self.miValue = self.customer.mname!
        }
        if self.customer.lname != nil{
            self.lNameValue = self.customer.lname!
        }
        ...
        self.sysNameValue = self.customer.sysname
        self.originalSysName = self.sysNameValue
        if self.customer.hear != nil{
            self.referredByValue = self.customer.hear!
        }
        if self.customer.active != nil{
            self.active = self.customer.active!
        }
        ...
        if self.customer.contacts != nil{
            for i in 0 ..< self.customer.contacts!.count{
                if customer.contacts![i].type == "3"{
                    //bill address
                    //self.billNameValue = self.customerJSON["customer"]["contacts"][i]["name"].stringValue
                    
                    self.billAddr1Value = customer.contacts![i].street1!
                    self.billAddr2Value = customer.contacts![i].street2!
                    self.billAddr3Value = customer.contacts![i].street3!
                    self.billAddr4Value = customer.contacts![i].street4!
                    self.billTownValue = customer.contacts![i].city!
                    self.billZipValue = customer.contacts![i].zip!
                    self.billStateValue = customer.contacts![i].state!
 ...
 */
                ...
                }else if customer.contacts![i].type == "4"{
                    
                    //jobsite address
                    
                    self.jobAddr1Value = customer.contacts![i].street1!
                    self.jobAddr2Value = customer.contacts![i].street2!
                    self.jobAddr3Value = customer.contacts![i].street3!
                    self.jobAddr4Value = customer.contacts![i].street4!
                    self.jobTownValue = customer.contacts![i].city!
                    self.jobZipValue = customer.contacts![i].zip!
                    self.jobStateValue = customer.contacts![i].state!
 ...
 */
    ...
    //Job Site
        ...
        print("self.referredByValue = \(self.referredByValue)")
        if self.referredByValue != ""{
            self.referredByTxtField.text = self.appDelegate.hearTypes[Int(self.referredByValue)!].type
        }
    ...
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int{
        ...
        if pickerView.tag == 0{
            ...
            count = self.appDelegate.hearTypes.count
        }
        return count
    }
    ...
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        if pickerView.tag == 0{
            ...
            return self.appDelegate.hearTypes[row].type
        }
    }
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int)
    {
        ...
        if pickerView.tag == 3 {
            self.referredByValue = self.appDelegate.hearTypes[row].ID
            self.referredByTxtField.text = self.appDelegate.hearTypes[row].type
            return
        }
    ...
    @objc func handleReferredByChange(){
        ...
        self.referredByValue = self.appDelegate.hearTypes[self.referredByPicker.selectedRow(inComponent: 0)].ID
        self.referredByTxtField.text = self.appDelegate.hearTypes[self.referredByPicker.selectedRow(inComponent: 0)].type
    ...
    @objc func submit(){
        ...
        parameters["companyName"] = self.companyTxtField.text as AnyObject
        parameters["salutation"] = self.salutationTxtField.text as AnyObject
        parameters["firstName"] = self.fNameTxtField.text as AnyObject
        parameters["middleName"] = self.miTxtField.text as AnyObject
        parameters["lastName"] = self.lNameTxtField.text as AnyObject
        parameters["sysName"] = self.sysNameTxtField.text as AnyObject
        
        parameters["nameChange"] = self.nameChange as AnyObject
        
        parameters["jobStreet1"] = self.jobAddr1TxtField.text as AnyObject
        parameters["jobStreet2"] = self.jobAddr2TxtField.text as AnyObject
        parameters["jobStreet3"] = self.jobAddr3TxtField.text as AnyObject
        parameters["jobStreet4"] = self.jobAddr4TxtField.text as AnyObject
        parameters["jobCity"] = self.jobTownTxtField.text as AnyObject
        parameters["jobState"] = self.jobStateTxtField.text as AnyObject
        parameters["jobZip"] = self.jobZipTxtField.text as AnyObject
        
        parameters["billStreet1"] = self.billAddr1TxtField.text as AnyObject
        parameters["billStreet2"] = self.billAddr2TxtField.text as AnyObject
        parameters["billStreet3"] = self.billAddr3TxtField.text as AnyObject
        parameters["billStreet4"] = self.billAddr4TxtField.text as AnyObject
        parameters["billCity"] = self.billTownTxtField.text as AnyObject
        parameters["billState"] = self.billStateTxtField.text as AnyObject
        parameters["billZip"] = self.billZipTxtField.text as AnyObject
        
        parameters["referredBy"] = self.referredByValue as AnyObject
        parameters["active"] = self.active as AnyObject
        parameters["customerID"] = self.customerID as AnyObject
        parameters["createdBy"] = self.appDelegate.defaults.string(forKey: loggedInKeys.loggedInId) as AnyObject
        
        parameters["sessionKey"] = self.appDelegate.defaults.string(forKey: loggedInKeys.sessionKey)! as AnyObject
        parameters["companyUnique"] = self.appDelegate.defaults.string(forKey: loggedInKeys.companyUnique)! as AnyObject
        ...
        layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/update/customer.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
            .validate()    // or, if you just want to check status codes, validate(statusCode: 200..<300)
            .responseString { response in
