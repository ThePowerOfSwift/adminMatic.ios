...
class NewEditEquipmentViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UITextViewDelegate, UpdateEquipmentImageDelegate, NoInternetDelegate {
    ...
    func getPickerInfo(){
        ...
        self.layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/get/equipmentFields.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil).responseJSON() {
            response in
            do {
    ...
    func layoutViews(){
        ...
        if(self.equipment == nil){
            ...
            self.equipment = Equipment2(_ID: "0", _name: "", _status: "0", _type: "")
