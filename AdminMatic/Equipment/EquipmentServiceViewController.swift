...
class EquipmentServiceViewController: UIViewController, UITextFieldDelegate, UITextViewDelegate, UIPickerViewDelegate, EditEquipmentServiceDelegate, NoInternetDelegate {
