...
protocol EmailDelegate{
    ...
    func addOneTimeEmail(_email:Contact2)
...
class EmailViewController: UIViewController, UITableViewDelegate, UITableViewDataSource,  UITextFieldDelegate,UITextViewDelegate, EmailDelegate, NoInternetDelegate {
    ...
    func getEmails() {
        ...
        layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/get/customerEmails.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
            ...
            .responseJSON(){
                ...
                do{
                    ...
                    let parsedData = try decoder.decode(ContactArray.self, from: json!)
                    ...
                    self.emails = parsedData.contacts
                    
                    self.selectedEmails = []
                    for _ in parsedData.contacts{
    ...
    func deleteEmail(_row:Int){
        ...
        let okAction = UIAlertAction(title: "Yes", style: UIAlertAction.Style.default) {
            ...
            parameters = ["contactID": ID as AnyObject, "custID":self.customerID as AnyObject, "sessionKey": self.appDelegate.defaults.string(forKey: loggedInKeys.sessionKey)! as AnyObject, "companyUnique": self.appDelegate.defaults.string(forKey: loggedInKeys.companyUnique)! as AnyObject]
    ...
    func updateTable(_newEmails:JSON){
        ...
        print("emailJSON = \(String(describing: emailJSON))")
 ...
 @objc func send() {
    ...
    let emails:String = emailsToSend.joined(separator: ", ")
        ...
        case "1":
            ...
            parameters = ["invoiceID": self.docID! as AnyObject, "emails":emails as AnyObject,  "title":self.titleTxt.text! as AnyObject, "message":self.messageTxt.text! as AnyObject, "pdf":self.convertToPDF as AnyObject, "senderID": self.appDelegate.defaults.string(forKey: loggedInKeys.loggedInId)! as AnyObject, "sessionKey": self.appDelegate.defaults.string(forKey: loggedInKeys.sessionKey)! as AnyObject, "companyUnique": self.appDelegate.defaults.string(forKey: loggedInKeys.companyUnique)! as AnyObject]
            
            
            print("parameters = \(parameters)")
            
            layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/send/invoice.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
                .validate()    // or, if you just want to check status codes, validate(statusCode: 200..<300)
                .responseString { response in
                    print("send response = \(response)")
                }
        ...
        case "2":
            ...
            parameters = ["contractID": self.docID! as AnyObject, "emails":emails as AnyObject,  "title":self.titleTxt.text! as AnyObject, "message":self.messageTxt.text! as AnyObject, "pdf":self.convertToPDF as AnyObject, "senderID": self.appDelegate.defaults.string(forKey: loggedInKeys.loggedInId)! as AnyObject, "sessionKey": self.appDelegate.defaults.string(forKey: loggedInKeys.sessionKey)! as AnyObject, "companyUnique": self.appDelegate.defaults.string(forKey: loggedInKeys.companyUnique)! as AnyObject]
            
            
            print("parameters = \(parameters)")
            
            layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/send/contract.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
                .validate()    // or, if you just want to check status codes, validate(statusCode: 200..<300)
                .responseString { response in
                    print("send response = \(response)")
                }
