...
class StackController:UIView, UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource, NoInternetDelegate{
    ...
    //loading view
        ...
        let parameters:[String:AnyObject]
         ...
         case 0:
            ...
            parameters = ["leadID": _ID as AnyObject, "sessionKey": self.appDelegate.defaults.string(forKey: loggedInKeys.sessionKey)! as AnyObject, "companyUnique": self.appDelegate.defaults.string(forKey: loggedInKeys.companyUnique)! as AnyObject]
         break
         case 1:
            contractBtn.backgroundColor = layoutVars.buttonColor1
            self.contractBtn.setTitleColor(UIColor.white, for: .normal)
            parameters = ["contractID": _ID as AnyObject, "sessionKey": self.appDelegate.defaults.string(forKey: loggedInKeys.sessionKey)! as AnyObject, "companyUnique": self.appDelegate.defaults.string(forKey: loggedInKeys.companyUnique)! as AnyObject]
         break
         case 2:
            workOrderBtn.backgroundColor = layoutVars.buttonColor1
            self.workOrderBtn.setTitleColor(UIColor.white, for: .normal)
            parameters = ["workOrderID": _ID as AnyObject, "sessionKey": self.appDelegate.defaults.string(forKey: loggedInKeys.sessionKey)! as AnyObject, "companyUnique": self.appDelegate.defaults.string(forKey: loggedInKeys.companyUnique)! as AnyObject]
         break
         case 3:
            invoiceBtn.backgroundColor = layoutVars.buttonColor1
            self.invoiceBtn.setTitleColor(UIColor.white, for: .normal)
            parameters = ["invoiceID": _ID as AnyObject, "sessionKey": self.appDelegate.defaults.string(forKey: loggedInKeys.sessionKey)! as AnyObject, "companyUnique": self.appDelegate.defaults.string(forKey: loggedInKeys.companyUnique)! as AnyObject]
         break
         default:
            leadBtn.backgroundColor = layoutVars.buttonColor1
            self.leadBtn.setTitleColor(UIColor.white, for: .normal)
        ...
        layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/get/systemStack.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
