...
class LayoutVars: UIViewController {
    ...
    var thirdWidth:CGFloat! = UIScreen.main.bounds.width/3
    ...
    let rawBase : String = "https://www.adminmatic.com/uploads/general/raw/"
    let mediumBase : String = "https://www.adminmatic.com/uploads/general/medium/"
    let thumbBase : String = "https://www.adminmatic.com/uploads/general/thumbs/"
    ...
    */
    ...
    var manager: Alamofire.SessionManager = {
        let serverTrustPolicies: [String: ServerTrustPolicy] = [
            "www.adminmatic.com": .disableEvaluation
        ]
    ...
    func showNoInternetVC(_navController:UINavigationController,_delegate: NoInternetDelegate){
            print("no internet")
            let noInternetViewController = NoInternetViewController()
           noInternetViewController.delegate = _delegate
            _navController.pushViewController(noInternetViewController, animated: false)
    }
    ...
    func grantAccess(_level:Int,_view:UIViewController)->Bool{
       ...
       // if (appDelegate.loggedInEmployee?.userLevel)! <= _level{
        if  Int(appDelegate.loggedInEmployee!.userLevel!)! <= _level{
    ...
    func determineUpcomingDate(_equipmentService:EquipmentService2)->String{
...
struct loggedInKeys {
    static let loggedInId = "ID"
    static let sessionKey = "session"
    static let companyUnique = "company"
