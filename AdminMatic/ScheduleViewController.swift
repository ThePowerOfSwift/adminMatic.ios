...
class ScheduleViewController: ViewControllerWithMenu, UITableViewDelegate, UITableViewDataSource, UISearchControllerDelegate, UISearchBarDelegate, UISearchDisplayDelegate, UISearchResultsUpdating, ScheduleDelegate, NoInternetDelegate{
    ...
    func getSchedule(_empID:String) {
        ...
        parameters = ["employeeID":_empID,"custID":"","startDate":self.startDateDB,"endDate":self.endDateDB,"sort":sort,"plowDepth":self.plowDepth,"active":"1","sessionKey": self.appDelegate.defaults.string(forKey: loggedInKeys.sessionKey)!,"companyUnique": self.appDelegate.defaults.string(forKey: loggedInKeys.companyUnique)!]
