    ...
    @objc func addEmail(){
        ...
        if self.email != nil{
            ...
            print("self.email != nil")
                ...
                self.layoutVars.manager.request("https://www.adminmatic.com/cp/app/functions/update/customerEmail.php",method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil)
            ...
            let cancelAction = UIAlertAction(title: "No", style: UIAlertAction.Style.destructive) {
                ...
                let email:Contact2 = Contact2(_ID: "0", _value: self.addTxt.text!)
                 //let email:Contact2 = Contact2(_ID: "0", _sort: "0", _type: <#T##String#>)
