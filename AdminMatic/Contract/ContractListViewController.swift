...
class ContractListViewController: ViewControllerWithMenu, UISearchControllerDelegate, UISearchBarDelegate, UISearchDisplayDelegate, UISearchResultsUpdating, UITableViewDelegate, UITableViewDataSource, ContractListDelegate, ContractSettingsDelegate, NoInternetDelegate{
    ...
    func getContracts(_openNewContract:Bool){
        ...
        parameters = ["status":self.status,"salesRep":self.salesRep,"companyUnique": self.appDelegate.defaults.string(forKey: loggedInKeys.companyUnique)!,"sessionKey": self.appDelegate.defaults.string(forKey: loggedInKeys.sessionKey)!]
