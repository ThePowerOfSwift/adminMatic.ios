...
import UIKit
class HomeViewController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, NoInternetDelegate  {
    ...
    func setLoggedInUserBtn(){
        print("setLoggedInUserBtn")
            ...
            print("pic = \(String(describing: appDelegate.loggedInEmployee?.pic!))")
        //print("https://adminmatic.com/"+(appDelegate.loggedInEmployee!.pic!))
                print("https://adminmatic.com\(appDelegate.loggedInEmployee!.pic!)")
            
            
            Alamofire.request("https://adminmatic.com"+(appDelegate.loggedInEmployee!.pic!)).responseImage { response in
               // debugPrint(response)
